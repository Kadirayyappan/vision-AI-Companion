...
GEMINI_API_KEY = 'AIzaSyCr-VJjpv4UnFuwVbfoeJnrPeBPKgcL3pY'  # Replace with your valid API key
...
# Main Title
st.markdown('<div class="main-title"> Vision AI Companion 👁️🖋️🔊</div>', unsafe_allow_html=True)

# Sidebar Features
st.sidebar.image(
    r"C:\Users\kadir\Downloads\vision ai\eye_image.jpg",
    width=250
)

# Sidebar "ℹ️ About" section with concise description
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <a href="https://www.linkedin.com/in/kadir-ayyappan2005" target="_blank"><img src="https://logosmarcas.net/wp-content/uploads/2020/03/LinkedIn-Emblema.png" alt="LinkedIn" width="40"/> LinkedIn</a> |
        <a href="https://github.com/Kadirayyappan" target="_blank"><img src="https://pngimg.com/uploads/github/github_PNG80.png" alt="GitHub" width="40"/> GitHub</a>
        <p>Credits: Kadir | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
